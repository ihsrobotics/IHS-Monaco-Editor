      ...
      <FormGroup>
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["presets"].includes("src")}
              onChange={(e) => handleCheckboxChange("presets", e)}
              name="src"
            />
          }
          label="src"
        ...
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["presets"].includes("include")}
              onChange={(e) => handleCheckboxChange("presets", e)}
              name="include"
            />
          }
        ...
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["presets"].includes("data")}
              onChange={(e) => handleCheckboxChange("presets", e)}
              name="data"
            />
          }
        ...
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["presets"].includes("bin")}
              onChange={(e) => handleCheckboxChange("presets", e)}
              name="bin"
            />
          }
