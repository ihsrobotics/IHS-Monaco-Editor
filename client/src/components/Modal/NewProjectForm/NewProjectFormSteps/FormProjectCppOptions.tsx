...
function FormProjectCppOptions({
  prevStep,
  nextStep,
  handleCheckboxChange,
  handleRadioChange,
  ...
  return (
    <>
      ...
      <FormGroup>
        <FormControlLabel
          control={
            <Checkbox
              ...
              onChange={(e) => handleCheckboxChange("include", e)}
            />
          }
          label="-I ./include"
        />
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["links"].includes("kipr")}
              onChange={(e) => handleCheckboxChange("links", e)}
              name="kipr"
            />
          }
          label="-lkipr"
        ...
        <FormControlLabel
          control={
            <Checkbox
              disableRipple
              defaultChecked={values["links"].includes("ihsboost")}
              onChange={(e) => handleCheckboxChange("links", e)}
              name="ihsboost"
            />
          }
      ...
      <FormControl>
        <FormLabel id="project-optimization-label" required>
          Optimization (-O)
        </FormLabel>
        <RadioGroup
          row
          aria-labelledby="project-optimization-label"
          name="projectType"
          onChange={handleRadioChange}
          defaultValue={values["optimization"]}
        >
          <FormControlLabel
            value="0"
